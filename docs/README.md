...
| [macos-packaging.md](./macos-packaging.md) | macOS arm64 DMG + dual-OS CI packaging decisions |

Product and setup docs live in the repo root [`README.md`](../README.md) and
[`reference_sandboxing.md`](../reference_sandboxing.md).
